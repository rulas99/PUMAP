...
def create_layout():
    ...
    mapa = dl.Map([dl.TileLayer(url=url, maxZoom=20, attribution=attribution),          
                 ...
                 dl.GestureHandling(),
                 dl.FeatureGroup(dl.EditControl(position="bottomleft",id="edit_control-c"))],
                 id="map-c", style={'width': '100%', 'height': '550px', 'margin': "auto", "display": "block"},
    ...
    layout = html.Div([
                        dbc.Row([dbc.Col(html.Div([html.H6('Centros culturales'),origen],
                                ...
                                dbc.Col(html.Div([html.A(dbc.Button('Ver!', id='ver-c', color='secondary', className='mr-1',
